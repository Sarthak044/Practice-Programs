...
crypto_workbook = xlsxwriter.Workbook('/home/sk/Documents/codes/python/crypto/Projects/project5/cryptocurrencies.xlsx')
...
for i in range(10):
    ...
    request = requests.get(listings_url, headers=headers1)
