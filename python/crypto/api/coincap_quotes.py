...
specific_crypto = input('Enter a ticker symbol for the crypto for ex. BTC/ETH/LUN: ')
global_url = base_url + '/v1/cryptocurrency/quotes/latest?convert=' + local_currency + '&symbol=' + specific_crypto
...
currency = results["data"][specific_crypto]
